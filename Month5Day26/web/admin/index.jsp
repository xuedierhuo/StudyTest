...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <iframe width="100%" id="iframe" name="iframe" onload="SetIFrameHeight()"
                frameborder="0" src="${pageContext.request.contextPath}/BusinessServlet?method=findAll&tab=1"></iframe>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2017 <a href="http://www.czxy.com">研究院研发部</a>.</strong> All rights reserved.
    </footer>
    <!-- 底部导航 /-->
</div>
</body>
