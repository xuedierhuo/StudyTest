		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<!-- 列表展示 start -->
					<c:forEach items="${hotProduct}" var="hp">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="product_info.htm">
								<img src="${hp.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="product_info.html" style='color:#666'>${hp.pname}</a></p>
							<p><font color="#E4393C" style="font-size:16px">&yen;${hp.shopPrice}</font></p>
						</div>
					</c:forEach>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProduct}" var="np">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="product_info.htm">
								<img src="${np.pimage}" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="product_info.html" style='color:#666'>${np.pname}</a></p>
							<p><font color="#E4393C" style="font-size:16px">&yen;${np.shopPrice}</font></p>
						</div>
					</c:forEach>
					<!-- 列表展示 end -->
				</div>
