			...
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<form id="formId" action="${pageContext.request.contextPath}/CartServlet" method="post">
							<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
								...
								<div style="margin:20px 0 10px 0;;text-align: center;">
									<%--加入到购物车 ${pageContext.request.contextPath}/jsp/cart.jsp--%>
									<a href="javascript:void(0)" onclick="cartSubmit()">
