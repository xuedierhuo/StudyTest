...
<body>
	<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath }/bookServlet?method=addBook" method="post">
		&nbsp;
		<table cellSpacing="1" cellPadding="5" width="980" align="center"
